...
class TestOutputSchemaMatchesProphet:
    ...
    def test_column_order_matches_prophet(self):
        ...
        assert list(forecast_prophet.columns) == list(forecast_seer.columns), \
    ...
    def test_uncertainty_bounds_for_all_components(self):
        ...
        for comp in components_with_bounds:
            ...
            assert f"{comp}_lower" in forecast.columns, f"Missing lower bound for {comp}"
            assert f"{comp}_upper" in forecast.columns, f"Missing upper bound for {comp}"
    ...
    def test_column_count(self):
        ...
        assert len(forecast_prophet.columns) == len(forecast_seer.columns), \
